...
\section{Benefits}
With the main benefactor of the thesis being the Swedish Sea Rescue Society, this thesis will have contributed to the development of modern rescue tooling which in the future can be used to save lives. Drones also show promise in other remote operations such as SAR in mountain environments \cite{drone-mountain-sar} and wildfire monitoring \cite{drones-wildfire}.

\section{Sustainability}
 Due to most small drones being very lightweight and electrically powered, they are also much more environmentally friendly compared to aircraft equipped with combustion engines.
