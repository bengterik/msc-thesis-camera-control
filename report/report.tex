...
The result script calculating the distance from the center of the apriltag to the center of the screen could during fast camera movements not detect the apriltag. This resulted in a NaN value for the distance. The average percentage of frames detected where 85\%, with a minimum of 80\% and a maximum of 89\%. The percentage of frames detected was not correlated with the delay (FIND OUT).
