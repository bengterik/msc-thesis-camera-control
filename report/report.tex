...
\chapter{Method}
This chapter will describe the experimental setup as well as how the experiment will be evaluated.
...
\begin{itemize}
   ...
   \item Camera gimbal and hoverboard
   \begin{itemize}
      \item Camera
...
The full experimental setup is illustrated in figure \ref{fig:exp-setup}. 

\subsection{Subject view}
When entering the room the subject is instructed to sit by the desk next to the conductor.

\subsection{Hoverboard}
There path of the hoverboard is a 2x1 meter large elipse and slightly to the  the shelf the camera gimbal is placed about 2.1 meters from the ground.
