...
This section aims to explain some of the design choices that were taken during development of the gimbal interface. It is only relevant if the reader is interested in the development process and can thus be skipped otherwise.
...
\begin{description}
   ...
   \item [Video encoding]
   Some video encodings are faster at the cost of quality and vice versa. MJPEG was chosen as the video encoding and the delay of the video feed was measured to be between 100-150ms. 
...
\section{Field testing}
The experience of controlling the camera could obviously be improved by lowering the delay, but the results were still satisfactory. 
