...
As the UAV is electrically powered, it does not produce any direct CO2 emissions during use. The results from early imagery to a rescue crew could allow them to go at lower speeds, reducing engine emissions as well as the boat's effects on the surrounding environment. 
...
\section{Ethics}
The software implemented in this thesis is aimed at assisting in SAR-operations and their functionality can as such be deemed critical to human life. Although the idea that aerial imagery is to be used as support, the intelligence provided by said footage has to be reliable as it can have an effect on the decisions on board a rescue vehicle. This places higher requirements on the robustness of the system. 
