...
\begin{table}[!hbt]
   \centering
      \begin{tabular}{|c|}
         \hline
         \textbf{What was your general experience of controlling the camera?} \\
         \hline
         \textbf{Did you experience any difference in the controls between the trials?} \\
         \hline
         \textbf{Was there any part of the track that was harder than any other?} \\
         \hline
         \textbf{Do you think the system would have been usable with the worst experimental conditions?} \\
         \hline
      \end{tabular}
   \caption{The questions asked for each delay after each trial.}
