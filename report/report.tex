...
\section{Strengths}
The test bed along with the evaluation method presented in this thesis is a novel approach to QoE experiments. Due to the design of the ArduPilot ecosystem, the test bed is also portable and would require no modification in order to work on other vehicles such as multirotors, rovers or submarines running the ArduPilot firmware.

It is also deemed a strength that the software could be used in a real flight scenario with the SSRS drone, proving it useful in a real world scenario.

\section{Benefits, Ethics and Sustainability}
With the main benefactor of the thesis being the Swedish Sea Rescue Society, this thesis will have contributed to the development of modern rescue tooling which in the future can be used to save lives. 

Drones also show promise in other remote operations such as SAR in mountain environments, remote inspection of the power grid or wildfire and wildlife monitoring which have previously been done by manned aircraft. Due to most small drones being very lightweight and electrically powered, they are also much more environmentally friendly compared to aircraft equipped with combustion engines.

From an ethical perspective it is also worth mentioning that the software developed in the thesis is general, and could be used in other types of applications such as border control, military operations and surveillance of civilians.
