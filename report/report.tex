...
\subsubsection{SSQ}
In \ref{fig:ssq-ans} the difference between the answers in the SSQ forms before and after the trials averaged over all subjects. The largest response increase is on symptom four, namely "eye strain", which had an average increase of  0.5. This result stems from four subjects reporting an increase, with one incrementing their response by 2. 
