...
The first concern is probably the least important concern when it comes to the validity of the study, as a low number of participants could be compensated for by each subject providing more data. Each subject generated around 13 500 data points five trials with two laps each, resulting in about 135 000 data points in total. This should have had a positive effect on the validity of the results.
