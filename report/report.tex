...
\subsection{Uv4l}
Uv4l is a streaming server solution that supports real-time communication protocols such as WebRTC \cite{uv4l}. In this thesis it is the software used to stream the local video feed over the web. 

\chapter{Method}
This chapter will describe the method used to perform the experiment.
...
\section{Evalutation}
The evaluation of the experiment will be done by both quantative and qualitative methods.

\subsection{Quantative Evaluation}
Have object detection running in the background and measure the error to the object.

\subsection{Qualitative Evaluation}
The user will get to respond to a QoE- as well as a sickness questionnaire after the experiment.
