...
Although the lab environment in which the experiment is conducted is a comparatively controlled environment, a natural consequence during the course of the project has been to evaluate the strengths and weaknesses of different system architectures. This section will bring up some of the different requieremnts along with the particular architectures considered for the application of sea rescue.

Being a real-time application over the Internet, there are many parts of the system that can induce latency. Thus, different tradeoffs have to be valued with the specific application in mind, and much thought and caer must go into selecting each of the software components that go into the system. 
