...
In the end stages of the thesis' work, the gimbal interface was tested on the SSRS during a real flying scenario over the Gothenburg archipelago. The goal of the field testing was to confirm that the software for controlling the gimbal would work on the actual drone in a real scenario as well as to collect data on the latency of the system. All communication with the drone was done over the mobile network.
