...
\section{Benefits}
With the main benefactor of the thesis being the Swedish Sea Rescue Society and the EOS-project, this thesis will have contributed to the development of modern rescue tooling which in the future could be used to save lives. Drones also show promise in other remote operations such as SAR in mountain environments \cite{drones-mountain-sar} as well as wildfire monitoring \cite{drones-wildfire}.
