...
\chapter{Test Beds}
This chapter will go through the technical details of the test beds and their components as were used in the experiments. First, all the hardware will be presented. Then, the pre-existing software along with the software implemented specifically for the thesis work will be detailed along with some discussion about design choices made.
...
\begin{description}
   ...
   \begin{figure}[htp]
      ...
      \caption{Schematics of the drone gimbal. The middle and left picture shows the gimbal with its full housing. To the right the housing has has been removed and a mockup camera module has been inserted in the mounting plate.}
