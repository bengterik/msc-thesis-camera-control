...
The future operators of the system will be the volunteers of SSRS, which have a wide variety in age and background. Considering the target audience there are two main concerns with the ecological validity of the study. Firstly, the subjects were all either students or researchers at Lund University and the average age was quite low. Secondly, the sample size was quite small. 
The first concern is probably more important than the second, as a low number of participants could be compensated for by ecah subject providing more data, around 13 500 data points five trials with two laps each. This probably had a large effect on the results.
The second concern is more difficult to compensate for, as only employees or students at the university could be used as subjects. There are of course people of different age and background working and studying at the university, but due to time restraints as well as the lack of compensation the subjects mostly came from the conductors network of contacts.
