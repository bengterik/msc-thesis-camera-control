...
The desire was to use the drone box to create a task that would be similar to what an operator would perform in a sea rescue scenario. A likely scenario was considedered to be that of a drone loitering around a point while trying to look toward what it was loitering around. 
