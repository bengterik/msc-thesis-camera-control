...
\begin{figure}[!hbt]
   ...
   \caption{An overview of the experimental setup. To the right the experiment conductor and subject by a desk facing right. On the left side, behind the shelf, the test bed including the camera and the hoverboard are located.}
   \label{fig:exp-setup}
\end{figure}

\subsection{Subject selection and recruitment}
In order for the subjects to be covered by insurance during the experiment, the subjects had to be either be students or employed by Lund University. The subjects were thus recruited mostly from the conductor's network of contacts.
...
The experiment starts with the subject being seated at the desk and where he or she will get to read and sign the consent form. 
