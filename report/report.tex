...
As the goal of this thesis work was to develop an application that could be used in a controlled experiment as well as in actual flight (in the span of a semester), there were many design choices that were taken into consideration during development. This section will discuss the main requirements of the system and the reasoning behind the design choices taken.
