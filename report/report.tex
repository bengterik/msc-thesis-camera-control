...
\begin{figure}[!hbt]
   ...
   \caption{The interface that the subject was presented with. The red dot in the middle of the screen is overlayed on the video feed so that the subject has a better reference of the center of the screen.}
   \label{fig:interface}
\end{figure}
...
To measure each subjects performance, each trial was recorded and a script using a detection algorithm gave the distance between the red dot and the center of the apriltag. A frame from the detection script can be seen in figure \ref{fig:resultcalc}.
