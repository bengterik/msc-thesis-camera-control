...
In conclusion, a versatile test bed allowing for manual control of a drone-mounted camera-gimbal was developed. For the SSRS, the GCI will serve as a starting point for controlling the drone's camera. Additionally, the GCI and the test bed developed in the thesis could be used in further research to better understand the relationship between different network parameters and an operator's QoE.
}
...
\chapter{Discussion}
In this chapter, a comparison between the functionality developed in the thesis to the state-of-the-art will be made. Furthermore, it will also discuss the work regarding its impact, limitations, weaknesses, strengths, sustainability and ethical implications.
