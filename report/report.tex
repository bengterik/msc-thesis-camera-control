...
After the task description and warm-up the tests commenced. The added latencies to be tested were 0, 200, 300, 400 and 600. At the beginning of each trial the interface was restarted with one of the latencies induced in the system. The subject was then asked to put the red marker in the middle of the screen in the middle of the apriltag. When the subject confirmed that they were ready to start the hoverboard was started. The subject followed the hoverboard for two laps, which took about 2 minutes in total.
